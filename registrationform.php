<?php
$my_email = "registration@icesdp.com";
$errors = array();
...
Thank you for registering for ICESDP 2017. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us the final version of your paper and a signed copyright form via email to info@icesdp.com. You can find the copyright form here: www.icesdp.com/papers. Please note that failing to do so may result in an unsuccessful process of your registration.

To reserve a room with a DISCOUNTED price, please fill out the provided booking form here: www.icesdp.com/accommodation/#Hotel_Alimara_Barcelona

You can find your registration details below. If there are any errors in the information you have provided, please write an email to us at registration@icesdp.com mentioning the correct information. Please note that you SHOULD NOT refill the form.
...
$your_subject = "Your Registration Details for ICESDP'17";

$your_headers = "From: ICESDP'17 <" . $my_email . ">";
...
<title>ICESDP'17 - Registration Form Filled!</title>
...
<p class="body" style="text-align:center!important; color: #FFF!important;">ICESDP'17 is part of the <b>2<sup>nd</sup> World Congress on Civil, Structural, and Environmental Engineering (CSEE'17)</b>.<br>For more information about the congress, please visit the website here: <a href="http://cseecongress.com/" class="body-link">www.cseecongress.com</a>.</p>
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      ...
      <p class="body">ICESDP 2017 will  be held in Ottawa, Canada on April 2 - 4, 2017 at the Alimara Hotel Barcelona.</p>
  ...
  <div>
      ...
      <p class="body">ICESDP attracts a wide range of researchers in the field of environmental sustainability, development, and protection. As a prominent company in the field of environmental sustainability, development, and protection, we would like to offer you an exhibit at ICESDP. Please visit <a href="../events" class="body-link">Events</a> for more information.</p>
    </div>
  </div>
    </div>
  </div>
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  ...
  <p class="body">If you have requested any official invitation letters, please allow up to 5 business days to receive your documents.</p> 
    ...
    <p class="body">If there are any problems in the information you have filled out, please write an email to us at <a href="mailto:registration@icesdp.com" class="body-link">registration@icesdp.com</a> mentioning the mistakes made. Please note that you SHOULD NOT refill the form.</p>

  <p class="body">We are looking forward to seeing you at ICESDP'17!</p>
  </div>
</div>
...
<footer id="contact">
  ...
  <div class="unit-spacer">
    ...
    +1-613-695-3040<br>
    <a href="mailto:info@icesdp.com">info@icesdp.com</a></p>
    </div>
  </div>
